    ...
    public partial class RE6 : UserControl
    {
        ...
        private void tglStamina_CheckedChanged(object sender)
        {
            if (attached)
            {
                ...
                {
                    PS4.WriteMemory(processID, 0xB9DA9B, new byte[] { 0x29, 0xD8 });
                }
                else
                {
        ...
        private void tglAssaultRifleAmmo_CheckedChanged(object sender)
        {
            if (attached)
            {
                ...
                {
                    PS4.WriteMemory(processID, 0xF324C4, new byte[] { 0x90, 0x90 });
                }
                else
                { 
                    PS4.WriteMemory(processID, 0xF324C4, new byte[] { 0x29, 0xF0 });
                }
            }
        }
    }
