...
namespace librpc// kidding right : )
{
    public class PS4RPC
    {
        ...
        private static Dictionary<RPC_STATUS, string> StatusMessages = new Dictionary<RPC_STATUS, string>()
        {
            ...
            { RPC_STATUS.RPC_WRITE_ERROR, "Make sure you send the payload before you launch your game not after and assure you have the correct CUSA and Version."},//before what the message was ? write error/ u smart I thought here
